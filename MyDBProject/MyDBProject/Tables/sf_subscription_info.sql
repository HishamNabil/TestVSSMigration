CREATE TABLE [dbo].[sf_subscription_info] (
    ...
    CONSTRAINT [pk_sf_subscription_info] PRIMARY KEY CLUSTERED ([sf_subscription_info_id] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [idx_sf_subscription_info_id2]
    ON [dbo].[sf_subscription_info]([id2] ASC) WITH (FILLFACTOR = 90);
