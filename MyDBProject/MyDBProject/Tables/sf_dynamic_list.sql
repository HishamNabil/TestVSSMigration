CREATE TABLE [dbo].[sf_dynamic_list] (
    ...
    CONSTRAINT [pk_sf_dynamic_list] PRIMARY KEY CLUSTERED ([sf_dynamic_list_id] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [idx_sf_dynmc_lst_dynmc_list_id]
    ON [dbo].[sf_dynamic_list]([dynamic_list_id] ASC) WITH (FILLFACTOR = 90);
