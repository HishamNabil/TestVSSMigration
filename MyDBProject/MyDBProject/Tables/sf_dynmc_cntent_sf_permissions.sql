CREATE TABLE [dbo].[sf_dynmc_cntent_sf_permissions] (
    ...
    CONSTRAINT [pk_sf_dynmc_cntnt_sf__A0DCFB00] PRIMARY KEY CLUSTERED ([base_id] ASC, [id] ASC) WITH (FILLFACTOR = 90),
...
CREATE NONCLUSTERED INDEX [idx_sf_dynmc_cntnt_sf_prmssns_]
    ON [dbo].[sf_dynmc_cntent_sf_permissions]([id] ASC) WITH (FILLFACTOR = 90);
