CREATE TABLE [dbo].[sf_draft_pages] (
    ...
    CONSTRAINT [pk_sf_draft_pages] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [idx_sf_draft_pages_page_id]
    ON [dbo].[sf_draft_pages]([page_id] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [sf_idx_FormName]
    ON [dbo].[sf_draft_pages]([nme] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [idx_sf_draft_pages_content_id]
    ON [dbo].[sf_draft_pages]([content_id] ASC) WITH (FILLFACTOR = 90);
