CREATE TABLE [dbo].[sf_wrkflw_dfntn_ddtnl_scnd_lvl] (
    ...
    CONSTRAINT [pk_sf_wrkflw_dfntn_dd_6936DCD4] PRIMARY KEY CLUSTERED ([id] ASC, [seq] ASC) WITH (FILLFACTOR = 90),
...
CREATE NONCLUSTERED INDEX [idx_sf_wrkflw_dfntn_ddtnl_scnd]
    ON [dbo].[sf_wrkflw_dfntn_ddtnl_scnd_lvl]([val] ASC) WITH (FILLFACTOR = 90);
