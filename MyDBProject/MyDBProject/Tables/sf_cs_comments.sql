CREATE TABLE [dbo].[sf_cs_comments] (
    ...
    CONSTRAINT [pk_sf_cs_comments] PRIMARY KEY CLUSTERED ([resolve_key] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [idx_sf_cs_comments_thread]
    ON [dbo].[sf_cs_comments]([parent_thread_id] ASC, [date_created] ASC) WITH (FILLFACTOR = 90);
