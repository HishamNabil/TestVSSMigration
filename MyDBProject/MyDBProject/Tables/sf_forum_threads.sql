CREATE TABLE [dbo].[sf_forum_threads] (
    ...
    CONSTRAINT [pk_sf_forum_threads] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [idx_forum_threads]
    ON [dbo].[sf_forum_threads]([forum_id] ASC, [last_post_date] ASC) WITH (FILLFACTOR = 90);
