CREATE TABLE [dbo].[dynmc_09451792f466c893dff0100b] (
    ...
    CONSTRAINT [pk_dynmc_09451792f466_2D6934F1] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [ref_dynmc_09451792f46_5CFF0E8D] FOREIGN KEY ([id]) REFERENCES [dbo].[sf_dynamic_type_base] ([id]) ON DELETE CASCADE
);
