CREATE TABLE [dbo].[sf_wrkflw_dfntn_ddtnl_frst_lvl] (
    ...
    CONSTRAINT [pk_sf_wrkflw_dfntn_dd_436CF226] PRIMARY KEY CLUSTERED ([id] ASC, [seq] ASC) WITH (FILLFACTOR = 90),
...
CREATE NONCLUSTERED INDEX [idx_sf_wrkflw_dfntn_ddtnl_frst]
    ON [dbo].[sf_wrkflw_dfntn_ddtnl_frst_lvl]([val] ASC) WITH (FILLFACTOR = 90);
