CREATE TABLE [dbo].[sf_lbraries_thumbnail_profiles] (
    ...
    CONSTRAINT [pk_sf_lbrrs_thmbnl_pr_AB6293EA] PRIMARY KEY CLUSTERED ([content_id] ASC, [seq] ASC) WITH (FILLFACTOR = 90),
...
CREATE NONCLUSTERED INDEX [idx_sf_lbrrs_thmbnl_prfles_val]
    ON [dbo].[sf_lbraries_thumbnail_profiles]([val] ASC) WITH (FILLFACTOR = 90);
