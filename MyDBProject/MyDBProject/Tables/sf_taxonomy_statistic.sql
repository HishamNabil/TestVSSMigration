CREATE TABLE [dbo].[sf_taxonomy_statistic] (
    ...
    CONSTRAINT [pk_sf_taxonomy_statistic] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [idx_sf_taxonomy_statistic]
    ON [dbo].[sf_taxonomy_statistic]([data_item_type] ASC, [taxon_id] ASC, [statistic_type] ASC, [item_provider_name] ASC) WITH (FILLFACTOR = 90);
