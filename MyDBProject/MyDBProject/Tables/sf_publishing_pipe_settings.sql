CREATE TABLE [dbo].[sf_publishing_pipe_settings] (
    ...
    CONSTRAINT [pk_sf_publishing_pipe_settings] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [idx_sf_pblshng_pp_settings_id3]
    ON [dbo].[sf_publishing_pipe_settings]([id3] ASC) WITH (FILLFACTOR = 90);
