CREATE TABLE [dbo].[sf_cnt_locations] (
    ...
    CONSTRAINT [pk_sf_cnt_locations] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE NONCLUSTERED INDEX [idx_cnt_locations_type]
    ON [dbo].[sf_cnt_locations]([app_name] ASC, [item_type] ASC, [item_provider] ASC, [priority] ASC) WITH (FILLFACTOR = 90);
