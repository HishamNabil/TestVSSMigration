CREATE TABLE [dbo].[sf_app_setting] (
    ...
    CONSTRAINT [pk_sf_app_setting] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 90)
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_setting_key]
    ON [dbo].[sf_app_setting]([nme] ASC, [policy_type] ASC, [policy_name] ASC) WITH (FILLFACTOR = 90);
