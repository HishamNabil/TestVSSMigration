CREATE TABLE [dbo].[sf_ntf_msg_jb_xcldd_rslvd_kys_] (
    ...
    CONSTRAINT [pk_sf_ntf_msg_jb_xcld_6290C7BE] PRIMARY KEY CLUSTERED ([id] ASC, [seq] ASC) WITH (FILLFACTOR = 90),
...
CREATE NONCLUSTERED INDEX [idx_sf_ntf_msg_jb_xcldd_rslvd_]
    ON [dbo].[sf_ntf_msg_jb_xcldd_rslvd_kys_]([val] ASC) WITH (FILLFACTOR = 90);
